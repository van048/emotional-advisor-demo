...
export default {
  ...
  "steps": [
    ...
    {
      "id": "736941",
      "description": "杯中倒入气泡水至八分满",
      "params": "",
      "type": "manual"
    },
    {
      "id": "736943",
      "description": "把咖啡杯放于出液口下方，使用COLMO咖啡机制作一份浓缩咖啡液，即可制作完成",
      "params": "",
      "type": "auto"
    }
  ],
  "reason": "这款莫吉托咖啡特别适合您此刻的心情和场景。它融合了薄荷的清新与青柠的微酸，加上气泡水的活力，能瞬间唤醒您的感官，驱散焦虑。在春日的阳光下，这杯清爽的咖啡能带来一丝清凉与愉悦，让您的心情变得轻松。",
  "reasons": [
    "清新治愈：薄荷与青柠的香气能舒缓焦虑情绪，带来清爽的味觉体验，仿佛春日微风拂面。",
    "活力提神：气泡水的跳跃感与咖啡的醇香结合，能迅速唤醒感官，为您注入一天所需的活力。",
    "慢节奏享受：制作过程简单却充满仪式感，让您在忙碌的早晨也能享受片刻专注与放松。"
  ],
  "duration": 300,
  "cupSize": "3",
  "temperature": 5,
