...
export default {
  ...
  "steps": [
    {
      "id": "736923",
      "description": "根据个人口味，在咖啡杯中加入1-2勺白砂糖",
      "params": ""
    },
    {
      "id": "736925",
    ...
    {
      "id": "736927",
      "description": "挤压柠檬块使柠檬汁滴入咖啡中。",
      "params": ""
    },
    {
      "id": "736929",
      "description": "将柠檬块放在咖啡杯的边缘作为装饰，即可制作完成",
      "params": ""
    }
  ],
  "reason": "用户当前情绪为焦虑，时间是白天，春季阳光明媚。罗马浓缩咖啡结合了柠檬的清香酸涩与白糖的甜味，这种酸甜清新的口感有助于缓解焦虑情绪，带来愉悦感。柠檬的香气和阳光明媚的天气相得益彰，制作简单快捷，适合在白天享用，能提供一份清爽的提神体验。",
  "reasons": [
    "情绪匹配：酸甜口味有助于缓解焦虑，带来愉悦感。",
    "季节匹配：春季适合清新口味的咖啡，柠檬的清香与春季气息相符。",
    "时间匹配：白天适合饮用清爽提神的咖啡，不会过于浓烈影响睡眠。",
    "天气匹配：阳光明媚的天气与柠檬的清新口感相得益彰。",
    "制作便捷：制作时间短（5分钟），难度较简单，适合快速制作。"
  ],
  "duration": 300,
  "cupSize": "3",
  "temperature": 90,
